...
DEFAULT_DATA = {
    ...
    "message": 'Tu thodi overthink karti hai. Yeh main pehle din se jaanta hoon.\n\nTu gusse mein alag hi lagti hai. Yeh bhi sach hai 😄\n\nTu bahut socially selective hai — aur honestly, mujhe yeh achha lagta hai.\n\nYeh jo bhi tune read kiya — sirf tera hai. 🌸',
    "quiz": [
...
@keyframes glowPulse {{
    ...
    50% {{ box-shadow: 0 4px 22px rgba(240,165,0,0.75); }}
}}
...
.stButton > button:hover {{
    ...
    box-shadow: 0 8px 24px {SHADOW} !important;
}}
...
# We use a small column trick to float the button top-right
...
if params.get("page") == "dev" or st.session_state.current_page == "dev":
    ...
    with tabs[0]:
        ...
        st.info("💡 Admin password (im@adi) is fixed.")
    ...
    with tabs[6]:
        ...
        if st.button("Save General 💾", key="save_gen"):
            d["recipient_name"] = new_name; d["home_subtitle"] = new_subtitle; d["footer"] = new_footer
            save_data(d); st.session_state.data = d
            st.success("✅ Saved!")
        st.markdown('</div>', unsafe_allow_html=True)
...
if page == "home":
    ...
    <div class="section-card">
        ...
        <p style="color:{TEXT_M};line-height:1.9;font-size:0.97rem;">
        Yeh jagah sirf tere liye bani hai. Jab bhi thoda down feel ho, ya bas kuch warm chahiye — yahan aa.<br><br>
        <b>Our Story</b> mein hamara safar hai 🌸, <b>Letter</b> mein kuch baatein hain jo main kehna chahta tha,
        <b>Mood</b> mein thoda support hai, aur <b>Quiz</b> mein main prove karoonga ki main tujhe kitna jaanta hoon 😄<br><br>
